...
float sumaTotalaMatrice(float** mat, int n)
{
	float suma = 0.0f;
	for (int i = 0; i < n; i++)
...
float sumaTotala4Vectori(int* coduri, char** denumiri, float* preturi, float* cantitati, int n)
{
	float suma = 0.0f;
	for (int i = 0; i < n; i++)
...
float sumaTotalaVector(produs *vp, int n)
{
	float suma = 0.0f;
	for (int i = 0; i < n; i++)
...
void main()
{
	...
	printf("Suma totala a produselor este: %5.2f", sumaTotalaVector(vp, n));
	...
	printf("Suma totala a produselor este: %5.2f", sumaTotala4Vectori(coduri, denumiri, preturi, cantitati, n));
	...
	printf("Suma totala a produselor este: %5.2f", sumaTotalaMatrice(mat, n));
